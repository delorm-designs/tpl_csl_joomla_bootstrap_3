...
for ($i = 0; $i < $this->tmpl['countcategories']; $i++) {
    ...
    echo '<tr>'."\n";
    echo '<td align="center" valign="middle" style="background: url(\'/components/com_phocagallery/assets/images/shadow1.png\') 50% 50% no-repeat; text-align:center;"><div class="pg-imgbg"><a href="'.$this->categories[$i]->link.'">';
